...
namespace FortniteLauncher.FortniteLauncher.Auth
{
    public partial class Auth
    {
        public static string GetToken(string authCode)
        {
            ...
            var TokenAcceso = JsonSerializer.Deserialize<Json.Token>(reply);
        ...
        public static string GetExchange(string token)
        {
            ...
            string reply = client.Execute(request).Content;
            var exchangeCode = JsonSerializer.Deserialize<Json.Exchange>(reply);
